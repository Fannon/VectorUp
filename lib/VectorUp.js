(function (mw, $) {
    ...
    try {
        ...
        var makeTableTag = function(tableClass, propertyName, name, cssClass, index, prepend) {
        ...
        makeTableTag('KontaktDatenAsk', 'Bevorzugt', 'bevorzugt', 'label label-warning', 5, true);
        makeTableTag('KontaktDatenAsk', 'Privat', 'privat', 'label label-danger', 5, true );
