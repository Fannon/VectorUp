(function (mw, $) {
    ...
    try {
        ...
        mw.libs.VectorUp.createTableTag = function(tableClass, propertyName, name, cssClass, booleanTag, index, prepend) {
            ...
            $('.' + tableClass + ' td.' + propertyName).each(function(i, el) {
                ...
                if (booleanTag && (el.textContent !== booleanTag)) {
                    return;
                } else {
                    if (prepend) {
        ...
        // tableClass, propertyName, name, cssClass, booleanTag, index, prepend
